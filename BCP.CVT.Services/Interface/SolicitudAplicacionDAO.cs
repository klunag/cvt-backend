...
namespace BCP.CVT.Services.Interface
{
    public abstract class SolicitudAplicacionDAO : ServiceProvider
    {
        ...
        public abstract DataResultAplicacion AgregarRolProducto(int id, string rol, string grupored, string descripcion, int tipocuenta, AmbienteGrupoRedDTO[] ambiente, string matricula, string nombre);

        public abstract DataResultAplicacion AgregarFuncion(string tribu, int id, string chater, List<string> funcion, string matricula, string nombre);
        ...
        public abstract DataResultAplicacion EditarRolProducto(int id, string rol, string grupored, string descripcion, int tipocuenta, AmbienteGrupoRedDTO[] ambiente, string matricula, string nombre);
        ...
        public abstract bool ExistsFuncionEnRol(string chapter, List<string> funcion, string producto, string rol);
        ...
        public abstract SolicitudFuncionDTO GetSolicitudMDRById(int id);

        public abstract FiltersRolesProducto GetRolesProductosCombo(string perfil, string matricula);
        public abstract FiltersRolesProducto GetVulnerabilidadesCombo(string perfil, string matricula);
        ...
        public abstract FiltersFuncionesProducto GetRolesProductosComboFuncionAgregar(string TribuId, string ChapterId, int RolProductoId);
        ...
        public abstract List<SolicitudFuncionDTO> GetSolicitudFuncionDetalle(PaginacionSolicitud pag, out int totalRows);
        ...
        public abstract List<ProductoDTO> GetProductosConsolidado(PaginacionSolicitud pag, out int totalRows);
        public abstract List<ProductoDTO> GetProductosDetallado(PaginacionSolicitud pag, out int totalRows);
        public abstract List<SolicitudFuncionDTO> GetSolicitudesMDRExportar(PaginacionSolicitud pag, out int totalRows);
        public abstract List<SolicitudFuncionDTO> GetFuncionSolicitudes(PaginacionSolicitud pag, out int totalRows);
        ...
        public abstract List<RelacionDTO> GetRelacionesAplicacionComponentes(PaginacionSolicitud pag, out int totalRows);
        public abstract List<RelacionDTO> GetRelacionesAplicacionAplicacion(PaginacionSolicitud pag, out int totalRows);
        public abstract List<RelacionDTO> GetListarRelacionesOwnersAPIs(PaginacionSolicitud pag, out int totalRows);
        public abstract List<RelacionDTO> GetListarRelacionesAzureResources(PaginacionSolicitud pag, out int totalRows);
        ...
        //public abstract DataResultAplicacion EnviarSolicitud(int idProducto, string comentario, string owner, string idOwner, string seguridad, string idSeguridad, string matricula, string nombre, int idSolicitud);
        public abstract DataResultAplicacion EnviarSolicitud(PaginacionSolicitudRol solicitud);
        public abstract int SolicitudRegistroRoles(PaginacionSolicitudRol solicitud);
        public abstract int SolicitudEliminacionRoles(PaginacionSolicitudRol solicitud);
        public abstract FiltersFuncionesProducto DevolverRolesSeguridad();
        public abstract bool ExisteFuncionesRolPorProducto(int idProducto);
        public abstract int ValidarMensajeSolicitudes(int idProducto, int idSolicitud);
        public abstract SolicitudRolDTO VerificarSolicitudProducto(int idProducto);
        public abstract FiltersRolesProducto GetSolicitudPorProducto(PaginacionSolicitudRol pag);
        public abstract bool VerificarFuncionesActivarPorRol(int idRolProducto);

        public abstract FiltersRolesProducto GetComboTipoCuentaAmbiente();
    }
}
