...
namespace BCP.CVT.Services.Interface.PortafolioAplicaciones
{
    public abstract partial class CommonDAO : ServiceProvider
    {
        ...
        public abstract FiltersAppStepTwo GetLInfraestuctureByApp(int appId);
        ...
        public abstract FilterArquitectoSoluciones GetListArquitectoSolution();
        public abstract FilterOwner GetListGetListsOwner();
