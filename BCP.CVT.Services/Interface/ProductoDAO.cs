...
namespace BCP.CVT.Services.Interface
{
    public abstract class ProductoDAO : ServiceProvider
    {
        ...
        public abstract List<ProductoDTO> GetProducto(string nombre, int? dominioId, int? subDominioId, bool Activo, int pageNumber, int pageSize, string sortName, string sortOrder, out int totalRows, bool withCantidadTecnologias = false);
        ...
        public abstract List<ProductoDTO> GetListaAutoCompletarProducto(string descripcion, string dominioIds = null, string subDominioIds = null);
        #endregion
    }
}
