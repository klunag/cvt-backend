...
namespace BCP.CVT.Services.ModelDB
{
    ...
    public partial class EquipoSoftwareBase
    {
        ...
        public Nullable<long> RelacionId { get; set; }
        public Nullable<bool> FlagAprobado { get; set; }
        public byte[] ArchivoConstancia { get; set; }
        public string NombreArchivo { get; set; }
        public int EquipoId { get; set; }
        public Nullable<int> SubdominioId { get; set; }
        public string TipoCertificadoCD { get; set; }
        public string DescripcionTipoCD { get; set; }
        public Nullable<System.DateTime> FechaCreadoCD { get; set; }
