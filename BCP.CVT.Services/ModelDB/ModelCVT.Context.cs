...
namespace BCP.CVT.Services.ModelDB
{
    ...
    public partial class GestionCMDB_ProdEntities : DbContext
    {
        ...
        public virtual DbSet<GuardicoreEtiquetadoEquipos> GuardicoreEtiquetadoEquipos { get; set; }
        public virtual DbSet<SolicitudRolFuncion> SolicitudRolFuncion { get; set; }
        public virtual DbSet<SolRolFuncionCabecera> SolRolFuncionCabecera { get; set; }
        public virtual DbSet<SolRolFuncionHistorial> SolRolFuncionHistorial { get; set; }
        public virtual DbSet<SolicitudRelacionFuncion> SolicitudRelacionFuncion { get; set; }
        public virtual DbSet<SolicitudRelacionFuncionDetalle> SolicitudRelacionFuncionDetalle { get; set; }
        ...
        public virtual DbSet<ConfiguracionTecnologiaCampos> ConfiguracionTecnologiaCampos { get; set; }
        public virtual DbSet<SolicitudTecnologia> SolicitudTecnologia { get; set; }
        public virtual DbSet<SolicitudTecnologiaCampos> SolicitudTecnologiaCampos { get; set; }
        public virtual DbSet<SolicitudTecnologiaFlujo> SolicitudTecnologiaFlujo { get; set; }
        public virtual DbSet<ProductoManagerRoles> ProductoManagerRoles { get; set; }
        public virtual DbSet<ProductoManager> ProductoManager { get; set; }
        public virtual DbSet<TecnologiaDetalleMaestra> TecnologiaDetalleMaestra { get; set; }
        public virtual DbSet<RolesProductoAmbiente> RolesProductoAmbiente { get; set; }
        public virtual DbSet<EquipoSoftwareBase> EquipoSoftwareBase { get; set; }
        public virtual DbSet<EquipoSolicitud> EquipoSolicitud { get; set; }
