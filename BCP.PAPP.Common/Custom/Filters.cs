...
namespace BCP.PAPP.Common.Custom
{
    ...
    public class FiltersAppStepOne
    {
        ...
        public List<CustomAutocompleteApplication> ArquitectoSoluciones { get; set; }
    }
    ...
    public class FiltersRolesProducto
    {
        ...
        public List<CustomAutocompleteApplication> Solicitud { get; set; }
        public List<CustomAutocompleteApplication> Estados { get; set; }
        public List<CustomAutocompleteApplication> TipoCuenta { get; set; }
        public List<CustomAutocompleteApplication> Ambiente { get; set; }
    }

    public class FiltersGestionUmbrales
    {
        public List<CustomAutocompleteApplication> TipoUmbral { get; set; }
        public List<CustomAutocompleteApplication> ValorUmbral { get; set; }
        public List<CustomAutocompleteApplication> DriverUmbral { get; set; }
        public List<CustomAutocompleteApplication> UnidadMUmbral { get; set; }
    ...
    public class FiltersFuncionesProducto
    {
        ...
        public List<CustomAutocompleteApplication> Seguridad { get; set; }
    }
    public class FiltersAppStepTwo
    {
        ...
        public List<CustomAutocompleteApplication> ArquitectoSolucion { get; set; }
        public List<CustomAutocompleteApplication> HorarioFuncionamiento { get; set; }
    }
    ...
    public class FilterArquitectoTI
    {
        ...
        public List<CustomAutocompleteApplication> TipoActivo { get; set; }
        public List<CustomAutocompleteApplication> ArquitectosTecnologia { get; set; }
    }
    public class FilterArquitectoSoluciones
    {
        public List<CustomAutocompleteApplication> CapaFuncional { get; set; }
        public List<CustomAutocompleteApplication> ArquitectosSolucion { get; set; }
    }
