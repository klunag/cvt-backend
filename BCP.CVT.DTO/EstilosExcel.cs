...
namespace BCP.CVT.DTO
{
    public class EstilosExcel
    {
        ...
        public int INDICE_DATOS_RED { get; set; }
        public int INDICE_DATOS_GREEN { get; set; }
        public int INDICE_DATOS_YELLOW { get; set; }
        ...
        public int INDICE_DATOS_BOLD { get; set; }
        public int INDICE_DATOS_BOLD_RED { get; set; }
        public int INDICE_DATOS_BOLD_GREEN { get; set; }
        public int INDICE_DATOS_BOLD_YELLOW { get; set; }
        public int INDICE_CABECERA_BLUE { get; set; }
        public int INDICE_CABECERA_GRAY { get; set; }
    }
}
